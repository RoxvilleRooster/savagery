...
| Armor Spikes | — | — | 10 | 50 
5+| Notes: May be added to any armor, causing +1 damage when Crushing while Grappling.
| Gauntlet, locked | — | — | 5 | 8 
5+| Notes: +1 to Strength roll against Disarm; requires an action to fasten/release.
