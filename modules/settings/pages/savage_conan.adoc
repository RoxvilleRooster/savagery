...
For a list of languages, see <<#language_list>>.
...
include::../partials/savage_conan_chargen.adoc[leveloffset=+1]


== Gear

include::../partials/fantasy_companion_gear.adoc[tag=armor,leveloffset=+1]

include::../partials/fantasy_companion_gear.adoc[tag=shields,leveloffset=+1]

include::../partials/fantasy_companion_gear.adoc[tag=melee,leveloffset=+1]

include::../partials/fantasy_companion_gear.adoc[tag=ranged,leveloffset=+1]

include::../partials/fantasy_companion_gear.adoc[tag=ammo,leveloffset=+1]