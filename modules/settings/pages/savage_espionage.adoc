...
===== Combat Medic
Requirements: Novice, Smarts D6+, Healing D6+

===== Computer Jock
Requirements: Novice, Smarts D6+, Hacking D8+

===== Deep Cover
Requirements: Seasoned, Undercover Work,
Performance D8+

====== Legendary Cover
Requirements: Veteran, Deep Cover, Performance
D10+
...
===== Tactical Driving
Requirements: Novice, Agility D6+, Driving D6+

====== Improved Tactical Driving
Requirements: Seasoned, Tactical Driving, Agility D8+, Boating Or Piloting D6+

===== Tradecraft
Requirements: Novice, Smarts D6+

====== Improved Tradecraft
Requirements: Seasoned, Level Headed, Tradecraft,
Agility D6+, Smarts D8+
